...
from src.telegram_aggregator.infrastructure.classifier.groq_classifier import GroqClassifier
from src.telegram_aggregator.infrastructure.classifier.openrouter_classifier import OpenrouterClassifier
...
def classify_content(data: ClassifyRequest):
    ...
    classifier = GroqClassifier(model=settings.groq_model, api_key=settings.groq_key,
